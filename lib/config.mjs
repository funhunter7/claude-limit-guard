...
function optionsToConfig(opts) {
  const out = {};
  if (opts.threshold != null && !Number.isNaN(Number(opts.threshold))) out.threshold = Number(opts.threshold);
  if (opts.warn_band != null && !Number.isNaN(Number(opts.warn_band))) out.warnBand = Number(opts.warn_band);
  if (opts.watch != null) {
