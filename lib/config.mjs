...
function envOverrides(env) {
  const opts = {};
  for (const key of ['threshold', 'warn_band', 'threshold_five_hour', 'threshold_seven_day', 'watch', 'locale', 'guard_action', 'warn_action', 'time_format', 'style', 'label_style', 'reset_display', 'projection_display']) {
