// Polish (pl) — best-effort translation, reviewed 2026-06; placeholders identical to en.mjs.
export default {
  signIn: 'zaloguj się',
  relIn: 'za',
  toThreshold: 'do',
  ...
  notifyReset: (window) => `Limit ${window} został zresetowany — możesz działać dalej.`,
  snoozeSet: (u) => `Strażnik wyciszony do ${u}.`,
  snoozeCleared: 'Wyciszenie anulowane.',
  snoozeNone: 'Brak aktywnego wyciszenia.',
  doctorHeader: 'autodiagnostyka claude-limit-guard',
  doctor_node: 'Node ≥ 18',
  doctor_token: 'token OAuth',
  doctor_statusline: 'pasek stanu podłączony',
  doctor_cache: 'świeży cache użycia',
  doctor_version: 'wersja wtyczki',
  doctorHint_node: 'Zaktualizuj Node do v18 lub nowszej.',
  doctorHint_token: 'Zaloguj się do Claude Code.',
  doctorHint_statusline: 'Uruchom /limit-guard-setup, aby podłączyć pasek stanu.',
  doctorHint_cache: 'Otwórz sesję Claude Code, aby pasek stanu odświeżył cache.',
  doctorHint_version: 'Zaktualizuj wtyczkę: /plugin update.',
  doctorVersionUnknown: 'najnowsza nieznana',
  setupWired: 'Pasek stanu podłączony do settings.json.',
  setupAlreadyWired: 'Pasek stanu już podłączony — nic do zrobienia.',
  setupBackedUp: (p) => `Poprzednie ustawienia zapisano do ${p}.`,
