// Russian (ru) — best-effort translation, reviewed 2026-06; placeholders identical to en.mjs.
export default {
  signIn: 'войти',
  relIn: 'через',
  toThreshold: 'до',
  ...
  snoozeSet: (u) => `Страж приглушён до ${u}.`,
  snoozeCleared: 'Приглушение отменено.',
  snoozeNone: 'Нет активного приглушения.',
  doctorHeader: 'самопроверка claude-limit-guard',
  doctor_node: 'Node ≥ 18',
  doctor_token: 'OAuth-токен',
  doctor_statusline: 'строка состояния подключена',
  doctor_cache: 'кэш использования свежий',
  doctor_version: 'версия плагина',
  doctorHint_node: 'Обнови Node до v18 или новее.',
  doctorHint_token: 'Войди в Claude Code.',
  doctorHint_statusline: 'Запусти /limit-guard-setup, чтобы подключить строку состояния.',
  doctorHint_cache: 'Открой сессию Claude Code, чтобы строка состояния обновила кэш.',
  doctorHint_version: 'Обнови плагин: /plugin update.',
  doctorVersionUnknown: 'последняя неизвестна',
  setupWired: 'Строка состояния подключена в settings.json.',
  setupAlreadyWired: 'Строка состояния уже подключена — делать нечего.',
  setupBackedUp: (p) => `Предыдущие настройки сохранены в ${p}.`,
