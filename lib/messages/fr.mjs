// French (fr) — best-effort translation, reviewed 2026-06; placeholders identical to en.mjs.
export default {
  signIn: 'se connecter',
  relIn: 'dans',
  toThreshold: "jusqu'à",
  ...
  doctorHeader: 'autodiagnostic claude-limit-guard',
  doctor_node: 'Node ≥ 18',
  doctor_token: 'token OAuth',
  doctor_statusline: 'barre d’état connectée',
  doctor_cache: 'cache d’usage récent',
  doctor_version: 'version du plugin',
  doctorHint_node: 'Mets à jour Node en v18 ou plus récent.',
  doctorHint_token: 'Connecte-toi à Claude Code.',
  doctorHint_statusline: 'Lance /limit-guard-setup pour connecter la barre d’état.',
  doctorHint_cache: 'Ouvre une session Claude Code pour que la barre d’état rafraîchisse le cache.',
  doctorHint_version: 'Mets à jour le plugin : /plugin update.',
  doctorVersionUnknown: 'dernière inconnue',
  setupWired: 'Barre d’état connectée dans settings.json.',
  setupAlreadyWired: 'Barre d’état déjà connectée — rien à faire.',
  setupBackedUp: (p) => `Anciens réglages sauvegardés dans ${p}.`,
