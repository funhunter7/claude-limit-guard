...
export default {
  ...
  notifyReset: (window) => `Limit ${window} se obnovil — můžeš zase naplno.`,
  // /limit-guard-snooze strings.
  snoozeSet: (u) => `Hlídač ztlumen do ${u}.`,
  snoozeCleared: 'Ztlumení zrušeno.',
  snoozeNone: 'Žádné aktivní ztlumení.',
  doctorHeader: 'kontrola claude-limit-guard',
  doctor_node: 'Node ≥ 18',
  doctor_token: 'OAuth token',
  doctor_statusline: 'status-line zapojena',
  doctor_cache: 'cache využití čerstvá',
  doctor_version: 'verze pluginu',
  doctorHint_node: 'Aktualizuj Node na verzi 18 nebo novější.',
  doctorHint_token: 'Přihlas se do Claude Code.',
  doctorHint_statusline: 'Spusť /limit-guard-setup pro zapojení status-line.',
  doctorHint_cache: 'Otevři relaci Claude Code, aby status-line obnovila cache.',
  doctorHint_version: 'Aktualizuj plugin: /plugin update.',
  doctorVersionUnknown: 'nejnovější neznámá',
  setupWired: 'Status-line zapojena do settings.json.',
  setupAlreadyWired: 'Status-line už je zapojena — není co dělat.',
  setupBackedUp: (p) => `Předchozí settings zazálohovány do ${p}.`,
