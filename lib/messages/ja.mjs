// Japanese (ja) — best-effort translation, reviewed 2026-06; placeholders identical to en.mjs.
export default {
  signIn: 'サインイン',
  relIn: 'あと',
  toThreshold: 'まで',
  ...
  doctorHeader: 'claude-limit-guard セルフチェック',
  doctor_node: 'Node ≥ 18',
  doctor_token: 'OAuth トークン',
  doctor_statusline: 'ステータスライン接続',
  doctor_cache: '利用キャッシュが新しい',
  doctor_version: 'プラグインのバージョン',
  doctorHint_node: 'Node を v18 以降に更新してください。',
  doctorHint_token: 'Claude Code にサインインしてください。',
  doctorHint_statusline: '/limit-guard-setup を実行してステータスラインを接続してください。',
  doctorHint_cache: 'Claude Code のセッションを開いてステータスラインにキャッシュを更新させてください。',
  doctorHint_version: 'プラグインを更新: /plugin update。',
  doctorVersionUnknown: '最新版不明',
  setupWired: 'ステータスラインを settings.json に設定しました。',
  setupAlreadyWired: 'ステータスラインは既に設定済みです — 操作不要。',
  setupBackedUp: (p) => `以前の設定を ${p} にバックアップしました。`,
